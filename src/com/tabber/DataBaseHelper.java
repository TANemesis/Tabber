...
public class DataBaseHelper extends SQLiteOpenHelper{
    ...
    private static String DB_PATH = "/data/data/com.tabber/databases/";
 
    private static String DB_NAME = "music.sqlite";
    
    private static String DATABASE_TABLE = "songs";
  ...
  /**
    ...
    {
    	try {
            return myDataBase.rawQuery("SELECT DISTINCT artist FROM SONGS", null);
        } catch (SQLException e) {
            Log.e("Exception on query", e.toString());
            return null;
        }
    }
	public Cursor showAlbums()
    {
    	try {
            return myDataBase.rawQuery("SELECT DISTINCT album FROM SONGS", null);
        } catch (SQLException e) {
            Log.e("Exception on query", e.toString());
            return null;
        }
